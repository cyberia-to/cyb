...
| aarch64-linux-android | RED | unavailable; see receipt |

## failures

- stack: expected exactly one platform receipt archive
...
- aarch64-apple-darwin: soft3-dependency — [Errno 2] No such file or directory: '/private/tmp/cyb-origin-candidate/sources/cyb/release/soft3.toml'
- aarch64-apple-darwin: cyb-check — red
- aarch64-apple-darwin: cyb-tests — cyb check failed; see cyb-check log
- aarch64-apple-darwin: cyb-fleet — cyb check failed; see cyb-check log
- aarch64-apple-darwin: cyb-dmg — cyb check failed; see cyb-check log
- aarch64-apple-darwin: package-resolution — cargo exited 101: error: failed to load manifest for workspace member `/private/tmp/cyb-origin-candidate/sources/cyb/shell`
referenced by workspace at `/private/tmp/cyb-origin-candidate/sources/cyb/Cargo.toml`

Caused by:
  failed to load manifest for dependency `nu-cli`

Caused by:
  failed to read `/private/tmp/cyb-origin-candidate/sources/nu/crates/nu-cli/Cargo.toml`

Caused by:
  No such file or directory (os error 2)
- aarch64-apple-darwin: qualification incomplete or binary unavailable
- x86_64-apple-darwin: expected exactly one platform receipt archive
- aarch64-unknown-linux-gnu: expected exactly one platform receipt archive
- x86_64-unknown-linux-gnu: expected exactly one platform receipt archive
- aarch64-linux-android: expected exactly one platform receipt archive
